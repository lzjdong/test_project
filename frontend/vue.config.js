...
module.exports = {
  productionSourceMap: parallel,
  publicPath: '/dataease-ui/',
  parallel,
  // 使用mock-server
  devServer: {
    port: port,
    proxy: {
      '^/dataease': {
        // target: 'http://192.168.3.58:8081/',
        target: 'http://192.168.3.234/',
        // target: 'http://192.168.3.60:9999/',
        // target: 'http://192.168.3.213:80/',
        changeOrigin: true,
        ws: true,
        pathRewrite: {
          // '^/dataease': '',
