  ...
  <div :class="classObj" class="app-wrapper">
    ...
    <div v-if="showTips" class="pwd-tips">
      ...
      <div style="text-align: right; margin-bottom: 10px">
        <el-button type="primary" size="mini" @click="showTips = false">
          {{ $t('commons.roger_that') }}
        </el-button>
      </div>
      <div class="arrow" />
    </div>
...
export default {
  ...
  computed: {
    ...
    fullHeightFlag() {
      return (
        this.$route.path.indexOf('panel') > -1 &&
        (this.componentName === 'PanelEdit' || this.componentName === 'ChartEdit')
      );
    },
    mainStyle() {
