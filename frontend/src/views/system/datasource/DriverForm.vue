<template>
  <layout-content>
    <template v-slot:header>
      ...
      <el-button v-if="canEdit" size="mini" style="float: right" type="primary" @click="save">
        {{ $t('commons.save') }}
      </el-button>
      <el-button v-else size="mini" style="float: right" type="primary" @click="changeEdit">
        {{ $t('commons.edit') }}
      </el-button>
    </template>
    <div>
...
export default {
  ...
  data() {
    return {
      ...
      rule: {
        name: [
          { required: true, message: i18n.t('datasource.input_name'), trigger: 'blur' },
          {
            min: 2,
            max: 50,
        ...
        type: [
          { required: true, message: i18n.t('datasource.please_choose_type'), trigger: 'blur' },
        ],
        driverClass: [
          { required: true, message: i18n.t('driver.please_set_driverClass'), trigger: 'blur' },
        ],
      },
      canEdit: false,
      driverFiles: [],
